...
from utils.data_loading import BasicDataset, CarvanaDataset, SyntheticDataset
from utils.dice_score import dice_loss
from evaluate import evaluate
from unet import UNet

dir_img = Path('../SyntheticDummyDataset_LightAndColor/data/train/')
dir_mask = Path('../SyntheticDummyDataset_LightAndColor/data/train/labels/')
...
def train_net(net,
              ...
              img_scale: float = 0.5,
              amp: bool = False,
              channels_sensors: int = [1,3]):
    # 1. Create dataset
    try:
        dataset = SyntheticDataset(dir_img, dir_mask, img_scale, channels_sensors)
